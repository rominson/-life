      ...
      if (isMobile) {
        ...
        if (navigator.share && navigator.canShare && navigator.canShare({ files: [] })) {
          try {
            ...
            const file = new File([blob], `LifeGrid-Certificate-${allCertificates[currentCertificateIndex].id}.png`, { type: 'image/png' });
            
            await navigator.share({
              files: [file],
              title: 'LifeGrid Certificate',
              text: 'My LifeGrid Time Guardian Certificate'
            });
            return;
          } catch (error) {
                      ...
                      `}>
                            ...
                            <div>
                              {isEditingCertificateName ? (
                                <div className="flex flex-col items-center gap-3">
                                  ...
                                  />
                                  <p className="text-[14px] text-stone-400 uppercase tracking-widest font-bold">Press Enter to Confirm</p>
                                </div>
                              ) : (
                                <div 
                          ...
                          <div className="w-full relative flex justify-between items-center mt-4 min-h-[120px]">
                            ...
                            <div className="text-right flex flex-col gap-4 min-w-[120px]">
                              <div>
                                <p className="text-[14px] text-[#a8a29e] uppercase tracking-widest font-bold mb-1 whitespace-nowrap">Certificate ID</p>
                              ...
                              <div>
                                <p className="text-[14px] text-[#a8a29e] uppercase tracking-widest font-bold mb-1 whitespace-nowrap">Issue Date</p>
