    ...
    <header className="bg-white/80 backdrop-blur-md border-b border-stone-100 px-4 md:px-8 py-4 flex items-center justify-between sticky top-0 z-50">
      <div className="flex items-center gap-3">
        ...
        <div className="hidden sm:block">
          <h1 className="text-lg font-serif font-bold text-stone-800 leading-tight">LifeGrid</h1>
          <p className="text-[10px] text-stone-400 uppercase tracking-widest font-medium">Chronicle of Existence</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        <div className="relative group">
          ...
          />
          <div className="absolute -top-2 left-3 bg-white px-1 text-[10px] text-stone-400 font-bold uppercase tracking-tighter">Birth Date</div>
        </div>
                ...
                <>
                  ...
                  >
                    <div className="p-4 border-b border-stone-50 bg-stone-50/50">
                      <p className="text-xs text-stone-400 font-bold uppercase tracking-widest mb-1">Signed in as</p>
