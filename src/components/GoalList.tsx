  ...
  return (
    <div className="bg-white rounded-[2.5rem] p-8 border border-stone-100 shadow-xl shadow-stone-100/50 flex flex-col min-h-0">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-serif font-bold text-stone-800">Life Milestones</h2>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-stone-400 font-bold uppercase tracking-widest">Target Age: {goal.age}</p>
                </div>
              </div>
              <button 
